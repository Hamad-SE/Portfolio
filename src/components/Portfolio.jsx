            ...
            <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-app">
              <div className="portfolio-content h-100">
                ...
                <div className="portfolio-info">
                  ...
                  <a href="https://auctify-mu.vercel.app/" title="Live Preview" className="details-link"><i className="bi bi-link-45deg"></i></a>
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-app">
              <div className="portfolio-content h-100">
                ...
                <div className="portfolio-info">
                  ...
                  <a href="https://snippet-saver.vercel.app/" title="Live Preview" className="details-link"><i className="bi bi-link-45deg"></i></a>
                </div>
              </div>
            </div>
          </div>
